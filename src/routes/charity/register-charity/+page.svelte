<script>
  ...
  <div class=" flex items-center justify-center ">
    <div class="w-full max-w-md  p-6 shadow-black ring-2 rounded-lg shadow-md">
      ...
      <form on:submit={verification}>
        ...
        {/if}
        <div class="mb-4">
            <label for="organzation" class="block  text-sm font-bold mb-2">Tell about your organization</label>
